...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<CheckBox>(R.id.checkbox).setOnCheckedChangeListener{v, b ->
...
//                Log.d("kkang", "move event x: ${event.x}, rawX: ${event.rawX}")
//                findViewById<TextView>(R.id.textView).text = "move event"
//            }
        }
